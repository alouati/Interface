/*global history */
sap.ui.define([
	"viseo/git/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"viseo/git/model/formatter",
	"sap/m/MessageBox",
	"viseo/git/model/grouper",
	...
	return BaseController.extend("viseo.git.controller.Master", {
		...
		onInit: function() {
			...
			this._oGroupSortState = new GroupSortState(oViewModel, grouper.Orderamount(this.getResourceBundle()));
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("viseo.git.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function(oEvent) {
			...
			aFilterItems.forEach(function(oItem) {
				switch (oItem.getKey()) {
					case "Filter1":
						aFilters.push(new Filter("Orderamount", FilterOperator.LE, 100));
						break;
					case "Filter2":
						aFilters.push(new Filter("Orderamount", FilterOperator.GT, 100));
						break;
					default:
						break;
				}
