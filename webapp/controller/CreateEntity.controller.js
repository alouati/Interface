sap.ui.define([
	...
	return BaseController.extend("viseo.git.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("documentHeaderSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("documentHeaderSet", oData);
