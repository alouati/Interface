sap.ui.define([
	...
	return BaseObject.extend("viseo.git.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias viseo.git.model.ListSelector
		 */
		 ...
		 * @return {viseo.git.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
