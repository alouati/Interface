sap.ui.define([
	...
	opaTest("MasterList Filtering on Orderamount less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("Orderamount").
	...
	opaTest("MasterList Filtering on Orderamount more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 Currency").
		and.iPressOKInViewSelectionDialog();
