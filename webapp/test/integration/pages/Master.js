		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "documentHeaderSet (0)"
						}),
						success: function() {
							Opa5.assert.ok(true, "The list header displays 'documentHeaderSet (0)'");
						},
				...
				theListShouldBeSortedAscendingOnUnitNumber: function() {
					return this.theListShouldBeSortedAscendingOnField("Orderamount");
				},
				...
				theListShouldHaveAllEntries: function() {
					...
					// retrieve all documentHeaderSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "documentHeaderSet (" + iExpectedLength + ")"
								}),
								success: function() {
