sap.ui.define([
	...
	return BaseObject.extend("viseo.git.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias viseo.git.model.GroupSortState
		 */
		...
		/**
		 * Sorts by Customername, or by Orderamount
		 *
		...
		/**
		 * Groups by Orderamount, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function(sKey) {
			...
			if (sKey === "Orderamount") {
				...
				this._oViewModel.setProperty("/sortBy", "Orderamount");

				aSorters.push(
					new Sorter("Orderamount", false,
